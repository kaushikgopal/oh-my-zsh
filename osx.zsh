...
scutil --set ComputerName "Air Kode"
scutil --set HostName "Air-Kode"
scutil --set LocalHostName "Air-Kode"

# Menu bar: Disable menu bar transparency
...
# Disable slow-mo animations (seen when you press Shift during Exposé launches or window minimization)
...
# Reduce Auto-hide dock time
# defaults write com.apple.dock autohide-time-modifier -float 0.2

# Enable the 2D Dock
defaults write com.apple.dock no-glass -bool true

# Orient the dock to the left hand side
...
# BBEdit sets the auto-complete delay to half a second (0.5)
# defaults write com.barebones.bbedit Editor:AutoCompleteDelay -float 0.1

# Hide Spotlight menu http://osxdaily.com/2011/12/12/hide-spotlight-menu-icon-mac-os-x-lion/
